    ...
    async def handle(
        ...
        *,
        ...
        try:
            ...
            source_cwd = (
                inherited_runtime_handle.cwd
                if inherited_runtime_handle and inherited_runtime_handle.cwd
                else os.getcwd()
            )
            ...
            if session_id:
                ...
                if reconstructed.is_err:
                    return Result.err(
                        MCPToolError(
                            f"Failed to reconstruct session: {reconstructed.error}",
                            tool_name="ouroboros_execute_seed",
                        )
                    )
            ...
            runner = OrchestratorRunner(
                ...
                task_cwd=workspace.effective_cwd if workspace else None,
